...
Source Code
===========
See the source code for method [LightFileWatcherService::error](https://github.com/lingtalfi/Light_FileWatcher/blob/master/Service/LightFileWatcherService.php#L290-L293)
